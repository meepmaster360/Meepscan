...
function banner() {
	clear
    echo -e "${GREEN} __  __  ____  ____  ____  ___   ___    __    _  _  ____  ____ ${NOCOLORS}"
	echo -e "${GREEN}(  \/  )( ___)( ___)(  _ \/ __) / __)  /__\  ( \( )( ___)(  _ \${NOCOLORS}"
	echo -e "${GREEN} )    (  )__)  )__)  )___/\__ \( (__  /(__)\  )  (  )__)  )   /${NOCOLORS}"
	echo -e "${GREEN}(_/\/\_)(____)(____)(__)  (___/ \___)(__)(__)(_)\_)(____)(_)\_)${NOCOLORS}"                                                                       
	echo -e "${GREEN}															${NOCOLORS}"
}
